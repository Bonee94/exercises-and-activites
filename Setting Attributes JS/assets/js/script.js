...
var siteHead = document.querySelectorAll("h4")

for (var i=0; i < siteHead.length; i++) {
    siteHead[i].setAttribute("style", "font-size:30px; color:blue; text-weight:bold; padding-left: 10px; margin:0;");
}
